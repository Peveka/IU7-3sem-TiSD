...
void display_main_menu(const simulation_config_t *config)
{
    ...
    printf("4 - Тестирование скорости (синтетическое)\n");
    printf("5 - Тестирование памяти (синтетическое)\n");
    printf("6 - Настройка времени заявок (T1)\n");
    printf("7 - Настройка времени обработки (T2)\n");
    printf("8 - Сравнительный анализ (инструкция)\n");
    printf("9 - Сравнение производительности (симуляции с текущими T1,T2)\n");
    printf("0 - Выход\n");
    printf("-------------------------------------------\n");
}
